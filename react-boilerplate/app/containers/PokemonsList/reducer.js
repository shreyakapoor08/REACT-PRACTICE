/*
 *
 * PokemonsList reducer
 *
 */

import { fromJS } from 'immutable';
import { DEFAULT_ACTION,GET_POKEMON_LIST} from './constants';
...
function pokemonsListReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return state;
      case GET_POKEMON_LIST:
        return state.set('pokemons', myObject.pokemons);
